...
dir=$HOME/.config/jalupa_config/dmenuscripts/background/splittedGifs
...
[[ ! -d $dir/$hash ]] && { mkdir $dir/$hash ; echo "splitting .." ; convert -coalesce $name $dir/$hash/$hash.png ; echo ok ; }
